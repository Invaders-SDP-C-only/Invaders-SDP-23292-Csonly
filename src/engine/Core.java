...
public final class Core {
    ...
    public static void main(final String[] args) {
        ...
        int returnCode = 1;
        do {
            // GameState is re-initialized inside case 2 based on player mode logic.
            ...
            switch (returnCode) {
                ...
                case 2: // Player Mode Selection (1P / 2P)
                    ...
                    returnCode = 9; // Proceed to Game Mode Selection
                    break;
                    ...
                    if (GameModeSelectScreen.TYPE_SANDBOX.equals(gameType)) {
                        ...
                        do {
                            ...
                            if (currentLevel == null) {
                                ...
                                // Between-level Shop
                                if (looping && (gameState.getLivesRemaining() > 0 || gameState.getLivesRemainingP2() > 0)) {
                                    SoundManager.stopAll();
                        ...
                        } while (looping && (gameState.getLivesRemaining() > 0 || gameState.getLivesRemainingP2() > 0));
